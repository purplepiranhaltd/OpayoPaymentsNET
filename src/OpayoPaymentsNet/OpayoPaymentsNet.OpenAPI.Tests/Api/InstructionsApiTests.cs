...
namespace OpayoPaymentsNet.OpenAPI.Tests.Api
{
    ...
    /// </remarks>
    public class InstructionsApiTests : IDisposable
    {
        private InstructionsApi instance;

        public InstructionsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' InstructionsApi
            //Assert.IsType<InstructionsApi>(instance);
        }

        /// <summary>
        /// Test CreateInstruction
        /// </summary>
        [Fact]
        public void CreateInstructionTest()
        {
            ...
            //CreateInstructionRequest createInstructionRequest = null;
            //var response = instance.CreateInstruction(UNKNOWN_PARAMETER_NAME, createInstructionRequest);
            //Assert.IsType<CreateInstruction201Response>(response);
        }
    }
}
