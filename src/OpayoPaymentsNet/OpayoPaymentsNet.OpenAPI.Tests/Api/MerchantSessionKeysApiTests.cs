...
using OpayoPaymentsNet.OpenAPI.Api;
// uncomment below to import models
//using Org.OpenAPITools.Model;

namespace OpayoPaymentsNet.OpenAPI.Tests.Api
{
    /// <summary>
    ///  Class for testing MerchantSessionKeysApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class MerchantSessionKeysApiTests : IDisposable
    {
        private MerchantSessionKeysApi instance;

        public MerchantSessionKeysApiTests()
        {
            instance = new MerchantSessionKeysApi();
        }
        ...
        /// <summary>
        /// Test an instance of MerchantSessionKeysApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' MerchantSessionKeysApi
            //Assert.IsType<MerchantSessionKeysApi>(instance);
        }
        ...
        /// </summary>
        [Fact]
        public void CreateMskTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //CreateMskRequest createMskRequest = null;
            //var response = instance.CreateMsk(createMskRequest);
            //Assert.IsType<MerchantSessionKeys>(response);
        }

        /// <summary>
        /// Test MerchantSessionKeysMerchantSessionKeyGet
        /// </summary>
        [Fact]
        public void MerchantSessionKeysMerchantSessionKeyGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string merchantSessionKey = null;
            //var response = instance.MerchantSessionKeysMerchantSessionKeyGet(merchantSessionKey);
            //Assert.IsType<MerchantSessionKeys>(response);
        }
    }
}
