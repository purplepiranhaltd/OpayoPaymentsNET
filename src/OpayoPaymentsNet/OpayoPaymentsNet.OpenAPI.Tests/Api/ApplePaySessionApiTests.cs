...
{
    /// <summary>
    ///  Class for testing ApplePaySessionApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class ApplePaySessionApiTests : IDisposable
    {
        private ApplePaySessionApi instance;

        public ApplePaySessionApiTests()
        {
            instance = new ApplePaySessionApi();
        }
        ...
        /// <summary>
        /// Test an instance of ApplePaySessionApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' ApplePaySessionApi
            //Assert.IsType<ApplePaySessionApi>(instance);
        }

        /// <summary>
        /// Test CreateAPSession
        /// </summary>
        [Fact]
        public void CreateAPSessionTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //CreateAPSessionRequest createAPSessionRequest = null;
            //var response = instance.CreateAPSession(createAPSessionRequest);
            //Assert.IsType<ApplePaySession>(response);
        }
    }
}
