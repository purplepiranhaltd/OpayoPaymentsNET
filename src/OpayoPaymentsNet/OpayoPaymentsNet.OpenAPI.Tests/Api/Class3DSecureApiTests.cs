...
{
    /// <summary>
    ///  Class for testing Class3DSecureApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class Class3DSecureApiTests : IDisposable
    {
        private Class3DSecureApi instance;

        public Class3DSecureApiTests()
        {
            instance = new Class3DSecureApi();
        }
        ...
        /// <summary>
        /// Test an instance of Class3DSecureApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' Class3DSecureApi
            //Assert.IsType<Class3DSecureApi>(instance);
        }

        /// <summary>
        /// Test Create3DSecurev2
        /// </summary>
        [Fact]
        public void Create3DSecurev2Test()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid transactionId = null;
            //Create3DSecurev2Request create3DSecurev2Request = null;
            //var response = instance.Create3DSecurev2(transactionId, create3DSecurev2Request);
