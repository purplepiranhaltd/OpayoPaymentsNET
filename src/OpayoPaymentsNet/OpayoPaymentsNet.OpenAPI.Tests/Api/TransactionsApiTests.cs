...
namespace OpayoPaymentsNet.OpenAPI.Tests.Api
{
    ...
    public class TransactionsApiTests : IDisposable
    {
        ...
        public void CreateTransactionTest()
        {
            ...
            //var response = instance.CreateTransaction(createTransactionRequest);
            //Assert.IsType<CreateTransaction201Response>(response);
        }
        ...
        public void RetrieveTransactionTest()
        {
            ...
            //var response = instance.RetrieveTransaction(transactionId);
            //Assert.IsType<RetrieveTransaction200Response>(response);
        }
    }
}
