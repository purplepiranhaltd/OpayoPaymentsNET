...
namespace OpayoPaymentsNet.OpenAPI.Tests.Model
{
    ...
    {
        // TODO uncomment below to declare an instance variable for Abort
        //private Abort instance;

        public AbortTests()
        {
            // TODO uncomment below to create an instance of Abort
            //instance = new Abort();
        }
        ...
        /// <summary>
        /// Test an instance of Abort
        /// </summary>
        [Fact]
        public void AbortInstanceTest()
        {
            // TODO uncomment below to test "IsType" Abort
            //Assert.IsType<Abort>(instance);
        }
