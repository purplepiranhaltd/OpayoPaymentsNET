...
namespace OpayoPaymentsNet.OpenAPI.Api
{
    ...
    /// </summary>
    public interface IApplePaySessionApiSync : IApiAccessor
    {
        ...
        /// <param name="createAPSessionRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplePaySession</returns>
        ApplePaySession CreateAPSession(CreateAPSessionRequest createAPSessionRequest = default, int operationIndex = 0);
        ...
        /// <param name="createAPSessionRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplePaySession</returns>
        ApiResponse<ApplePaySession> CreateAPSessionWithHttpInfo(CreateAPSessionRequest createAPSessionRequest = default, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IApplePaySessionApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of ApplePaySession</returns>
        Task<ApplePaySession> CreateAPSessionAsync(CreateAPSessionRequest createAPSessionRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplePaySession)</returns>
        Task<ApiResponse<ApplePaySession>> CreateAPSessionWithHttpInfoAsync(CreateAPSessionRequest createAPSessionRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IApplePaySessionApi : IApplePaySessionApiSync, IApplePaySessionApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ApplePaySessionApi : IApplePaySessionApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplePaySessionApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ApplePaySessionApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ApplePaySessionApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ApplePaySessionApi(Configuration configuration)
        {
        ...
        public ApplePaySessionApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Create an Apple Pay Session When you create an Apple Pay Session you must specify the Opayo vendor name linked to your API [authentication credentials](#section/Authentication).
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="createAPSessionRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplePaySession</returns>
        public ApplePaySession CreateAPSession(CreateAPSessionRequest createAPSessionRequest = default, int operationIndex = 0)
        {
            ApiResponse<ApplePaySession> localVarResponse = CreateAPSessionWithHttpInfo(createAPSessionRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplePaySession</returns>
        public ApiResponse<ApplePaySession> CreateAPSessionWithHttpInfo(CreateAPSessionRequest createAPSessionRequest = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Data = createAPSessionRequest;

            localVarRequestOptions.Operation = "ApplePaySessionApi.CreateAPSession";
            ...
            var localVarResponse = Client.Post<ApplePaySession>("/apple-pay-session", localVarRequestOptions, Configuration);
            if (ExceptionFactory != null)
            {
                Exception _exception = ExceptionFactory("CreateAPSession", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApplePaySession</returns>
        public async Task<ApplePaySession> CreateAPSessionAsync(CreateAPSessionRequest createAPSessionRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ApiResponse<ApplePaySession> localVarResponse = await CreateAPSessionWithHttpInfoAsync(createAPSessionRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplePaySession)</returns>
        public async Task<ApiResponse<ApplePaySession>> CreateAPSessionWithHttpInfoAsync(CreateAPSessionRequest createAPSessionRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await AsynchronousClient.PostAsync<ApplePaySession>("/apple-pay-session", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
