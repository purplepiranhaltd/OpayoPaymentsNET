...
namespace OpayoPaymentsNet.OpenAPI.Api
{
    ...
    /// </summary>
    public interface IClass3DSecureApiSync : IApiAccessor
    {
        ...
        /// <param name="create3DSecurev2Request">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Card</returns>
        Card Create3DSecurev2(Guid transactionId, Create3DSecurev2Request create3DSecurev2Request = default, int operationIndex = 0);
        ...
        ApiResponse<Card> Create3DSecurev2WithHttpInfo(Guid transactionId, Create3DSecurev2Request create3DSecurev2Request = default, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IClass3DSecureApiAsync : IApiAccessor
    {
        ...
        Task<Card> Create3DSecurev2Async(Guid transactionId, Create3DSecurev2Request create3DSecurev2Request = default, int operationIndex = 0, CancellationToken cancellationToken = default);
        ...
        Task<ApiResponse<Card>> Create3DSecurev2WithHttpInfoAsync(Guid transactionId, Create3DSecurev2Request create3DSecurev2Request = default, int operationIndex = 0, CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IClass3DSecureApi : IClass3DSecureApiSync, IClass3DSecureApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Class3DSecureApi : IClass3DSecureApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="Class3DSecureApi"/> class.
        /// </summary>
        /// <returns></returns>
        public Class3DSecureApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Class3DSecureApi(string basePath)
        {
        ...
        /// <returns></returns>
        public Class3DSecureApi(Configuration configuration)
        {
        ...
        public Class3DSecureApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Create a 3D Secure challenge response (3DSv2) We will create and return the 3D Secure object (containing the 3D result) within the transaction object.   **Please note that the &#x60;cRes&#x60; for a transaction has to be provided within 20 minutes from our initial response.** 
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="transactionId"></param>
        /// <param name="create3DSecurev2Request">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Card</returns>
        public Card Create3DSecurev2(Guid transactionId, Create3DSecurev2Request create3DSecurev2Request = default, int operationIndex = 0)
        {
            ApiResponse<Card> localVarResponse = Create3DSecurev2WithHttpInfo(transactionId, create3DSecurev2Request);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Card</returns>
        public ApiResponse<Card> Create3DSecurev2WithHttpInfo(Guid transactionId, Create3DSecurev2Request create3DSecurev2Request = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Data = create3DSecurev2Request;

            localVarRequestOptions.Operation = "Class3DSecureApi.Create3DSecurev2";
            ...
            var localVarResponse = Client.Post<Card>("/transactions/{transactionId}/3d-secure-challenge", localVarRequestOptions, Configuration);
            if (ExceptionFactory != null)
            {
                Exception _exception = ExceptionFactory("Create3DSecurev2", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Card</returns>
        public async Task<Card> Create3DSecurev2Async(Guid transactionId, Create3DSecurev2Request create3DSecurev2Request = default, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ApiResponse<Card> localVarResponse = await Create3DSecurev2WithHttpInfoAsync(transactionId, create3DSecurev2Request, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Card)</returns>
        public async Task<ApiResponse<Card>> Create3DSecurev2WithHttpInfoAsync(Guid transactionId, Create3DSecurev2Request create3DSecurev2Request = default, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await AsynchronousClient.PostAsync<Card>("/transactions/{transactionId}/3d-secure-challenge", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
