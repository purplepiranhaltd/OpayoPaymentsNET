...
namespace OpayoPaymentsNet.OpenAPI.Api
{
    ...
    /// </summary>
    public interface IMerchantSessionKeysApiSync : IApiAccessor
    {
        ...
        /// <param name="createMskRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>MerchantSessionKeys</returns>
        MerchantSessionKeys CreateMsk(CreateMskRequest createMskRequest = default, int operationIndex = 0);
        ...
        /// <param name="createMskRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MerchantSessionKeys</returns>
        ApiResponse<MerchantSessionKeys> CreateMskWithHttpInfo(CreateMskRequest createMskRequest = default, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>MerchantSessionKeys</returns>
        MerchantSessionKeys MerchantSessionKeysMerchantSessionKeyGet(string merchantSessionKey, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MerchantSessionKeys</returns>
        ApiResponse<MerchantSessionKeys> MerchantSessionKeysMerchantSessionKeyGetWithHttpInfo(string merchantSessionKey, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMerchantSessionKeysApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of MerchantSessionKeys</returns>
        Task<MerchantSessionKeys> CreateMskAsync(CreateMskRequest createMskRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MerchantSessionKeys)</returns>
        Task<ApiResponse<MerchantSessionKeys>> CreateMskWithHttpInfoAsync(CreateMskRequest createMskRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default);
        /// <summary>
        /// Check Merchant Session Key validity
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MerchantSessionKeys</returns>
        Task<MerchantSessionKeys> MerchantSessionKeysMerchantSessionKeyGetAsync(string merchantSessionKey, int operationIndex = 0, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MerchantSessionKeys)</returns>
        Task<ApiResponse<MerchantSessionKeys>> MerchantSessionKeysMerchantSessionKeyGetWithHttpInfoAsync(string merchantSessionKey, int operationIndex = 0, CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMerchantSessionKeysApi : IMerchantSessionKeysApiSync, IMerchantSessionKeysApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MerchantSessionKeysApi : IMerchantSessionKeysApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantSessionKeysApi"/> class.
        /// </summary>
        /// <returns></returns>
        public MerchantSessionKeysApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public MerchantSessionKeysApi(string basePath)
        {
        ...
        /// <returns></returns>
        public MerchantSessionKeysApi(Configuration configuration)
        {
        ...
        public MerchantSessionKeysApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Create a new Merchant Session Key When you create a &#x60;merchantSessionKey&#x60; you must specify the Opayo vendor name linked to your API [authentication credentials](#section/Authentication).
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="createMskRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>MerchantSessionKeys</returns>
        public MerchantSessionKeys CreateMsk(CreateMskRequest createMskRequest = default, int operationIndex = 0)
        {
            ApiResponse<MerchantSessionKeys> localVarResponse = CreateMskWithHttpInfo(createMskRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MerchantSessionKeys</returns>
        public ApiResponse<MerchantSessionKeys> CreateMskWithHttpInfo(CreateMskRequest createMskRequest = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Data = createMskRequest;

            localVarRequestOptions.Operation = "MerchantSessionKeysApi.CreateMsk";
            ...
            var localVarResponse = Client.Post<MerchantSessionKeys>("/merchant-session-keys", localVarRequestOptions, Configuration);
            if (ExceptionFactory != null)
            {
                Exception _exception = ExceptionFactory("CreateMsk", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MerchantSessionKeys</returns>
        public async Task<MerchantSessionKeys> CreateMskAsync(CreateMskRequest createMskRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ApiResponse<MerchantSessionKeys> localVarResponse = await CreateMskWithHttpInfoAsync(createMskRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MerchantSessionKeys)</returns>
        public async Task<ApiResponse<MerchantSessionKeys>> CreateMskWithHttpInfoAsync(CreateMskRequest createMskRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await AsynchronousClient.PostAsync<MerchantSessionKeys>("/merchant-session-keys", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Check Merchant Session Key validity Supply the &#x60;merchantSessionKey&#x60; and we will check its validity and return the &#x60;expiry&#x60;
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="merchantSessionKey"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>MerchantSessionKeys</returns>
        public MerchantSessionKeys MerchantSessionKeysMerchantSessionKeyGet(string merchantSessionKey, int operationIndex = 0)
        {
            ApiResponse<MerchantSessionKeys> localVarResponse = MerchantSessionKeysMerchantSessionKeyGetWithHttpInfo(merchantSessionKey);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MerchantSessionKeys</returns>
        public ApiResponse<MerchantSessionKeys> MerchantSessionKeysMerchantSessionKeyGetWithHttpInfo(string merchantSessionKey, int operationIndex = 0)
        {
            // verify the required parameter 'merchantSessionKey' is set
            if (merchantSessionKey == null)
            {
                throw new ApiException(400, "Missing required parameter 'merchantSessionKey' when calling MerchantSessionKeysApi->MerchantSessionKeysMerchantSessionKeyGet");
            }
            ...
            localVarRequestOptions.PathParameters.Add("merchantSessionKey", ClientUtils.ParameterToString(merchantSessionKey)); // path parameter

            localVarRequestOptions.Operation = "MerchantSessionKeysApi.MerchantSessionKeysMerchantSessionKeyGet";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<MerchantSessionKeys>("/merchant-session-keys/{merchantSessionKey}", localVarRequestOptions, Configuration);
            if (ExceptionFactory != null)
            {
                Exception _exception = ExceptionFactory("MerchantSessionKeysMerchantSessionKeyGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MerchantSessionKeys</returns>
        public async Task<MerchantSessionKeys> MerchantSessionKeysMerchantSessionKeyGetAsync(string merchantSessionKey, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ApiResponse<MerchantSessionKeys> localVarResponse = await MerchantSessionKeysMerchantSessionKeyGetWithHttpInfoAsync(merchantSessionKey, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MerchantSessionKeys)</returns>
        public async Task<ApiResponse<MerchantSessionKeys>> MerchantSessionKeysMerchantSessionKeyGetWithHttpInfoAsync(string merchantSessionKey, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'merchantSessionKey' is set
            if (merchantSessionKey == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await AsynchronousClient.GetAsync<MerchantSessionKeys>("/merchant-session-keys/{merchantSessionKey}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
