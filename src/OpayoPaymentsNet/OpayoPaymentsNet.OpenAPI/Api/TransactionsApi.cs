...
namespace OpayoPaymentsNet.OpenAPI.Api
{
    ...
    public interface ITransactionsApiSync : IApiAccessor
    {
        ...
        /// <param name="createTransactionRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CreateTransaction201Response</returns>
        CreateTransaction201Response CreateTransaction(CreateTransactionRequest createTransactionRequest = default, int operationIndex = 0);
        ...
        /// <param name="createTransactionRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateTransaction201Response</returns>
        ApiResponse<CreateTransaction201Response> CreateTransactionWithHttpInfo(CreateTransactionRequest createTransactionRequest = default, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetrieveTransaction200Response</returns>
        RetrieveTransaction200Response RetrieveTransaction(string transactionId, int operationIndex = 0);
        ...
        /// <param name="transactionId"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetrieveTransaction200Response</returns>
        ApiResponse<RetrieveTransaction200Response> RetrieveTransactionWithHttpInfo(string transactionId, int operationIndex = 0);
    ...
    public interface ITransactionsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of CreateTransaction201Response</returns>
        Task<CreateTransaction201Response> CreateTransactionAsync(CreateTransactionRequest createTransactionRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateTransaction201Response)</returns>
        Task<ApiResponse<CreateTransaction201Response>> CreateTransactionWithHttpInfoAsync(CreateTransactionRequest createTransactionRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default);
        /// <summary>
        /// Retrieve a Transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetrieveTransaction200Response</returns>
        Task<RetrieveTransaction200Response> RetrieveTransactionAsync(string transactionId, int operationIndex = 0, CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetrieveTransaction200Response)</returns>
        Task<ApiResponse<RetrieveTransaction200Response>> RetrieveTransactionWithHttpInfoAsync(string transactionId, int operationIndex = 0, CancellationToken cancellationToken = default);
    ...
    public partial class TransactionsApi : ITransactionsApi
    {
        ...
        /// <summary>
        /// Create a Transaction There are different request objects that can be sent, depending on the transaction type or payment method: 
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="createTransactionRequest">Request payload (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CreateTransaction201Response</returns>
        public CreateTransaction201Response CreateTransaction(CreateTransactionRequest createTransactionRequest = default, int operationIndex = 0)
        {
            ApiResponse<CreateTransaction201Response> localVarResponse = CreateTransactionWithHttpInfo(createTransactionRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateTransaction201Response</returns>
        public ApiResponse<CreateTransaction201Response> CreateTransactionWithHttpInfo(CreateTransactionRequest createTransactionRequest = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "TransactionsApi.CreateTransaction";
            ...
            var localVarResponse = Client.Post<CreateTransaction201Response>("/transactions", localVarRequestOptions, Configuration);
            if (ExceptionFactory != null)
            {
                Exception _exception = ExceptionFactory("CreateTransaction", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CreateTransaction201Response</returns>
        public async Task<CreateTransaction201Response> CreateTransactionAsync(CreateTransactionRequest createTransactionRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ApiResponse<CreateTransaction201Response> localVarResponse = await CreateTransactionWithHttpInfoAsync(createTransactionRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateTransaction201Response)</returns>
        public async Task<ApiResponse<CreateTransaction201Response>> CreateTransactionWithHttpInfoAsync(CreateTransactionRequest createTransactionRequest = default, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await AsynchronousClient.PostAsync<CreateTransaction201Response>("/transactions", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a Transaction Supply a valid &#x60;transactionId&#x60; and we will provide you with the transaction object.
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="transactionId"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetrieveTransaction200Response</returns>
        public RetrieveTransaction200Response RetrieveTransaction(string transactionId, int operationIndex = 0)
        {
            ApiResponse<RetrieveTransaction200Response> localVarResponse = RetrieveTransactionWithHttpInfo(transactionId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetrieveTransaction200Response</returns>
        public ApiResponse<RetrieveTransaction200Response> RetrieveTransactionWithHttpInfo(string transactionId, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "TransactionsApi.RetrieveTransaction";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<RetrieveTransaction200Response>("/transactions/{transactionId}", localVarRequestOptions, Configuration);
            if (ExceptionFactory != null)
            {
                Exception _exception = ExceptionFactory("RetrieveTransaction", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetrieveTransaction200Response</returns>
        public async Task<RetrieveTransaction200Response> RetrieveTransactionAsync(string transactionId, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            ApiResponse<RetrieveTransaction200Response> localVarResponse = await RetrieveTransactionWithHttpInfoAsync(transactionId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetrieveTransaction200Response)</returns>
        public async Task<ApiResponse<RetrieveTransaction200Response>> RetrieveTransactionWithHttpInfoAsync(string transactionId, int operationIndex = 0, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'transactionId' is set
            if (transactionId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await AsynchronousClient.GetAsync<RetrieveTransaction200Response>("/transactions/{transactionId}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
