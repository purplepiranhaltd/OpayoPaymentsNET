...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayPal_paypal")]
    public partial class PayPalPaypal : IEquatable<PayPalPaypal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayPalPaypal" /> class.
        /// </summary>
        /// <param name="redirectUrl">The PayPal URL to redirect your customer to..</param>
        /// <param name="orderId">The PayPal order ID..</param>
        public PayPalPaypal(string redirectUrl = default, string orderId = default)
        {
        ...
        /// </summary>
        /// <value>The PayPal URL to redirect your customer to.</value>
        ...
        /// The PayPal order ID.
        /// </summary>
        /// <value>The PayPal order ID.</value>
        ...
        {
            return Equals(input as PayPalPaypal);
        }

        /// <summary>
        /// Returns true if PayPalPaypal instances are equal
        /// </summary>
        /// <param name="input">Instance of PayPalPaypal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayPalPaypal input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (RedirectUrl != null && RedirectUrl.Length > 200)
            {
                yield return new ValidationResult("Invalid value for RedirectUrl, length must be less than 200.", new[] { "RedirectUrl" });
            }

            // OrderId (string) maxLength
            if (OrderId != null && OrderId.Length > 200)
            {
                yield return new ValidationResult("Invalid value for OrderId, length must be less than 200.", new[] { "OrderId" });
            }
