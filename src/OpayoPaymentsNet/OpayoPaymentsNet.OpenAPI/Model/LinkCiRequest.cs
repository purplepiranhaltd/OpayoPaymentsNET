...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// LinkCiRequest
    /// </summary>
    [DataContract(Name = "linkCi_request")]
    public partial class LinkCiRequest : IEquatable<LinkCiRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkCiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LinkCiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkCiRequest" /> class.
        /// </summary>
        /// <param name="securityCode">The card security code, also known as CV2, CVV or CVC, this is used in CV2 checks. (required).</param>
        public LinkCiRequest(string securityCode = default)
        {
            // to ensure "securityCode" is required (not null)
            if (securityCode == null)
            {
                throw new ArgumentNullException("securityCode is a required property for LinkCiRequest and cannot be null");
            }
        ...
        {
            return Equals(input as LinkCiRequest);
        }

        /// <summary>
        /// Returns true if LinkCiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkCiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkCiRequest input)
        {
            if (input == null)
            {
                return false;
