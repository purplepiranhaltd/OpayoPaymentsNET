...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    public partial class Release : IEquatable<Release>, IValidatableObject
    {
        ...
        /// <param name="amount">The amount property is compulsory for a &#39;release&#39; instruction after a &#39;Deferred&#39; transaction. The amount charged to the customer in the smallest currency unit. (e.g 100 pence to charge £1.00, or 1 to charge ¥1 (0-decimal currency)..</param>
        public Release(InstructionTypeEnum? instructionType = default, int amount = default)
        {
        ...
        /// <summary>
        /// The amount property is compulsory for a &#39;release&#39; instruction after a &#39;Deferred&#39; transaction. The amount charged to the customer in the smallest currency unit. (e.g 100 pence to charge £1.00, or 1 to charge ¥1 (0-decimal currency).
        /// </summary>
        /// <value>The amount property is compulsory for a &#39;release&#39; instruction after a &#39;Deferred&#39; transaction. The amount charged to the customer in the smallest currency unit. (e.g 100 pence to charge £1.00, or 1 to charge ¥1 (0-decimal currency).</value>
        ...
        {
            return Equals(input as Release);
        }
