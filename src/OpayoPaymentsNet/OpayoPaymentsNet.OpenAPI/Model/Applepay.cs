...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Applepay")]
    public partial class Applepay : IEquatable<Applepay>, IValidatableObject
    {
        /// <summary>
        ...
        public Applepay(string transactionId = default, TransactionTypeEnum? transactionType = default, StatusEnum? status = default, string statusCode = default, string statusDetail = default, CardAdditionalDeclineDetail additionalDeclineDetail = default, string retrievalReference = default, string settlementReferenceText = default, string bankResponseCode = default, string bankAuthorisationCode = default, AvsCvcCheck avsCvcCheck = default, RetrieveTransaction200ResponsePaymentMethod paymentMethod = default, Amount amount = default, string currency = default)
        {
        ...
        {
            return Equals(input as Applepay);
        }

        /// <summary>
        /// Returns true if Applepay instances are equal
        /// </summary>
        /// <param name="input">Instance of Applepay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Applepay input)
        {
            if (input == null)
            {
                return false;
