...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Paypal_paymentMethod")]
    public partial class PaypalPaymentMethod : IEquatable<PaypalPaymentMethod>, IValidatableObject
    {
        ...
        public PaypalPaymentMethod(PaypalPaymentMethodPaypal paypal = default)
        {
            Paypal = paypal;
        }
        ...
        public PaypalPaymentMethodPaypal Paypal { get; set; }
        ...
        {
            return Equals(input as PaypalPaymentMethod);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (Paypal != null)
                {
                    hashCode = hashCode * 59 + Paypal.GetHashCode();
                }
                return hashCode;
            }
        }
