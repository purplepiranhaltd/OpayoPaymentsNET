...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// CardIdentifiers
    /// </summary>
    [DataContract(Name = "CardIdentifiers")]
    public partial class CardIdentifiers : IEquatable<CardIdentifiers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardIdentifiers" /> class.
        /// </summary>
        /// <param name="cardIdentifier">The unique identifier used to submit the card details in the transaction registration. This identifier will represent the customer card details..</param>
        /// <param name="expiry">Date/Time the card identifier will expire in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format.</param>
        /// <param name="cardType">The type of the card (Visa, MasterCard, American Express, Diners, etc.).</param>
        public CardIdentifiers(string cardIdentifier = default, string expiry = default, string cardType = default)
        {
        ...
        /// <summary>
        /// The unique identifier used to submit the card details in the transaction registration. This identifier will represent the customer card details.
        /// </summary>
        /// <value>The unique identifier used to submit the card details in the transaction registration. This identifier will represent the customer card details.</value>
        [DataMember(Name = "cardIdentifier", EmitDefaultValue = false)]
        public string CardIdentifier { get; set; }

        /// <summary>
        /// Date/Time the card identifier will expire in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format
        /// </summary>
        /// <value>Date/Time the card identifier will expire in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format</value>
        [DataMember(Name = "expiry", EmitDefaultValue = false)]
        public string Expiry { get; set; }

        /// <summary>
        /// The type of the card (Visa, MasterCard, American Express, Diners, etc.)
        /// </summary>
        /// <value>The type of the card (Visa, MasterCard, American Express, Diners, etc.)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CardIdentifiers {\n");
        ...
        {
            return Equals(input as CardIdentifiers);
        }

        /// <summary>
        /// Returns true if CardIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of CardIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardIdentifiers input)
        {
            if (input == null)
            {
                return false;
