...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateTransaction201ResponseJsonConverter))]
    [DataContract(Name = "createTransaction_201_response")]
    public partial class CreateTransaction201Response : AbstractOpenAPISchema, IEquatable<CreateTransaction201Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransaction201Response" /> class
        /// with the <see cref="Card" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Card.</param>
        public CreateTransaction201Response(Card actualInstance)
        {
            IsNullable = false;
            SchemaType = "oneOf";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransaction201Response" /> class
        /// with the <see cref="Applepay" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Applepay.</param>
        public CreateTransaction201Response(Applepay actualInstance)
        {
            IsNullable = false;
            SchemaType = "oneOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(Applepay))
                {
                    _actualInstance = value;
                }
                else if (value.GetType() == typeof(Card))
                {
                    _actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: Applepay, Card");
                }
            }
        }
        ...
        public Card GetCard()
        {
            return (Card)ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `Applepay`. If the actual instance is not `Applepay`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of Applepay</returns>
        public Applepay GetApplepay()
        {
            return (Applepay)ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateTransaction201Response {\n");
        ...
        /// <summary>
        /// Converts the JSON string into an instance of CreateTransaction201Response
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of CreateTransaction201Response</returns>
        public static CreateTransaction201Response FromJson(string jsonString)
        {
            CreateTransaction201Response newCreateTransaction201Response = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newCreateTransaction201Response;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(Applepay).GetProperty("AdditionalProperties") == null)
                {
                    newCreateTransaction201Response = new CreateTransaction201Response(JsonConvert.DeserializeObject<Applepay>(jsonString, SerializerSettings));
                }
                else
                {
                    newCreateTransaction201Response = new CreateTransaction201Response(JsonConvert.DeserializeObject<Applepay>(jsonString, AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("Applepay");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Applepay: {1}", jsonString, exception.ToString()));
            }
            ...
            try
            {
                ...
                {
                    newCreateTransaction201Response = new CreateTransaction201Response(JsonConvert.DeserializeObject<Card>(jsonString, SerializerSettings));
                }
                else
                {
                    newCreateTransaction201Response = new CreateTransaction201Response(JsonConvert.DeserializeObject<Card>(jsonString, AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return Equals(input as CreateTransaction201Response);
        }

        /// <summary>
        /// Returns true if CreateTransaction201Response instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTransaction201Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTransaction201Response input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for CreateTransaction201Response
    /// </summary>
    public class CreateTransaction201ResponseJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)typeof(CreateTransaction201Response).GetMethod("ToJson").Invoke(value, null));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return CreateTransaction201Response.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
