...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// Repeat
    /// </summary>
    [DataContract(Name = "Repeat")]
    public partial class Repeat : IEquatable<Repeat>, IValidatableObject
    {
        /// <summary>
        ...
        public Repeat(TransactionTypeEnum? transactionType = default, string referenceTransactionId = default, string vendorTxCode = default, int amount = default, string currency = default, string description = default, ShippingDetails shippingDetails = default, bool giftAid = false, CredentialTypeRepeat credentialType = default)
        {
        ...
        public CredentialTypeRepeat CredentialType { get; set; }
        ...
        {
            return Equals(input as Repeat);
        }

        /// <summary>
        /// Returns true if Repeat instances are equal
        /// </summary>
        /// <param name="input">Instance of Repeat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Repeat input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for Description, length must be less than 40.", new[] { "Description" });
            }
