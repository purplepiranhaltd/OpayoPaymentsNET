...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Card_additionalDeclineDetail")]
    public partial class CardAdditionalDeclineDetail : IEquatable<CardAdditionalDeclineDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardAdditionalDeclineDetail" /> class.
        /// </summary>
        /// <param name="additionalDeclineCode">This contains the additional decline code. (example values, 03, R1, N4, 59 etc.).</param>
        /// <param name="additionalDeclineCodeDescription">Description of the additional decline code. This will vary according to your acquiring bank.</param>
        /// <param name="additionalDeclineCodeCategory">This is the category of the decline. Currently there are 4 categories, but could increase in future. (Example 01, 02, 03, 04.)    01: Card declined, do not re-attempt within a rolling 30 day period.    02: Card issuer cannot approve at this time. Re-attempt authorisation permitted, but limited to 15 re-attempts within a rolling 30 day period.    03: Incorrect data, or updated or additional card account information is required. For these the authorisation data will need to be corrected before re-attempt. Such issues are incorrect / missing expiry date, authentication value. Contact cardholder and correct information. Note: Limited to 15 re-attempts within a rolling 30 day period and no more than 25,000 category 03 declines per MID per rolling 30 day period per card scheme.    04: Re-attempt authorisation permitted. Re-attempts limited to 15 within a rolling 30 day period.  .</param>
        public CardAdditionalDeclineDetail(string additionalDeclineCode = default, string additionalDeclineCodeDescription = default, string additionalDeclineCodeCategory = default)
        {
            AdditionalDeclineCode = additionalDeclineCode;
            AdditionalDeclineCodeDescription = additionalDeclineCodeDescription;
            AdditionalDeclineCodeCategory = additionalDeclineCodeCategory;
        }

        /// <summary>
        /// This contains the additional decline code. (example values, 03, R1, N4, 59 etc.)
        /// </summary>
        /// <value>This contains the additional decline code. (example values, 03, R1, N4, 59 etc.)</value>
        [DataMember(Name = "additionalDeclineCode", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Description of the additional decline code. This will vary according to your acquiring bank</value>
        [DataMember(Name = "additionalDeclineCodeDescription", EmitDefaultValue = false)]
        public string AdditionalDeclineCodeDescription { get; set; }

        /// <summary>
        /// This is the category of the decline. Currently there are 4 categories, but could increase in future. (Example 01, 02, 03, 04.)    01: Card declined, do not re-attempt within a rolling 30 day period.    02: Card issuer cannot approve at this time. Re-attempt authorisation permitted, but limited to 15 re-attempts within a rolling 30 day period.    03: Incorrect data, or updated or additional card account information is required. For these the authorisation data will need to be corrected before re-attempt. Such issues are incorrect / missing expiry date, authentication value. Contact cardholder and correct information. Note: Limited to 15 re-attempts within a rolling 30 day period and no more than 25,000 category 03 declines per MID per rolling 30 day period per card scheme.    04: Re-attempt authorisation permitted. Re-attempts limited to 15 within a rolling 30 day period.  
        /// </summary>
        /// <value>This is the category of the decline. Currently there are 4 categories, but could increase in future. (Example 01, 02, 03, 04.)    01: Card declined, do not re-attempt within a rolling 30 day period.    02: Card issuer cannot approve at this time. Re-attempt authorisation permitted, but limited to 15 re-attempts within a rolling 30 day period.    03: Incorrect data, or updated or additional card account information is required. For these the authorisation data will need to be corrected before re-attempt. Such issues are incorrect / missing expiry date, authentication value. Contact cardholder and correct information. Note: Limited to 15 re-attempts within a rolling 30 day period and no more than 25,000 category 03 declines per MID per rolling 30 day period per card scheme.    04: Re-attempt authorisation permitted. Re-attempts limited to 15 within a rolling 30 day period.  </value>
        [DataMember(Name = "additionalDeclineCodeCategory", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CardAdditionalDeclineDetail {\n");
            sb.Append("  AdditionalDeclineCode: ").Append(AdditionalDeclineCode).Append("\n");
            sb.Append("  AdditionalDeclineCodeDescription: ").Append(AdditionalDeclineCodeDescription).Append("\n");
            sb.Append("  AdditionalDeclineCodeCategory: ").Append(AdditionalDeclineCodeCategory).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return Equals(input as CardAdditionalDeclineDetail);
        }

        /// <summary>
        /// Returns true if CardAdditionalDeclineDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of CardAdditionalDeclineDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardAdditionalDeclineDetail input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                (
                    AdditionalDeclineCode == input.AdditionalDeclineCode ||
                    AdditionalDeclineCode != null &&
                    AdditionalDeclineCode.Equals(input.AdditionalDeclineCode)
                ) &&
                (
                    AdditionalDeclineCodeDescription == input.AdditionalDeclineCodeDescription ||
                    AdditionalDeclineCodeDescription != null &&
                    AdditionalDeclineCodeDescription.Equals(input.AdditionalDeclineCodeDescription)
                ) &&
                (
                    AdditionalDeclineCodeCategory == input.AdditionalDeclineCodeCategory ||
                    AdditionalDeclineCodeCategory != null &&
                    AdditionalDeclineCodeCategory.Equals(input.AdditionalDeclineCodeCategory)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (AdditionalDeclineCode != null)
                {
                    hashCode = hashCode * 59 + AdditionalDeclineCode.GetHashCode();
                }
                if (AdditionalDeclineCodeDescription != null)
                {
                    hashCode = hashCode * 59 + AdditionalDeclineCodeDescription.GetHashCode();
                }
                if (AdditionalDeclineCodeCategory != null)
                {
                    hashCode = hashCode * 59 + AdditionalDeclineCodeCategory.GetHashCode();
                }
                return hashCode;
            }
        }
        ...
        {
            // AdditionalDeclineCode (string) maxLength
            if (AdditionalDeclineCode != null && AdditionalDeclineCode.Length > 2)
            {
                yield return new ValidationResult("Invalid value for AdditionalDeclineCode, length must be less than 2.", new[] { "AdditionalDeclineCode" });
            }

            // AdditionalDeclineCode (string) minLength
            if (AdditionalDeclineCode != null && AdditionalDeclineCode.Length < 2)
            {
                yield return new ValidationResult("Invalid value for AdditionalDeclineCode, length must be greater than 2.", new[] { "AdditionalDeclineCode" });
            }

            // AdditionalDeclineCodeDescription (string) maxLength
            if (AdditionalDeclineCodeDescription != null && AdditionalDeclineCodeDescription.Length > 255)
            {
                yield return new ValidationResult("Invalid value for AdditionalDeclineCodeDescription, length must be less than 255.", new[] { "AdditionalDeclineCodeDescription" });
            }

            // AdditionalDeclineCodeCategory (string) maxLength
            if (AdditionalDeclineCodeCategory != null && AdditionalDeclineCodeCategory.Length > 2)
            {
                yield return new ValidationResult("Invalid value for AdditionalDeclineCodeCategory, length must be less than 2.", new[] { "AdditionalDeclineCodeCategory" });
            }

            // AdditionalDeclineCodeCategory (string) minLength
            if (AdditionalDeclineCodeCategory != null && AdditionalDeclineCodeCategory.Length < 2)
            {
                yield return new ValidationResult("Invalid value for AdditionalDeclineCodeCategory, length must be greater than 2.", new[] { "AdditionalDeclineCodeCategory" });
            }
