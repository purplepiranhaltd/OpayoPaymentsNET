...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateTransactionRequestJsonConverter))]
    [DataContract(Name = "createTransaction_request")]
    public partial class CreateTransactionRequest : AbstractOpenAPISchema, IEquatable<CreateTransactionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateTransactionRequest(Payment actualInstance)
        {
            IsNullable = false;
            SchemaType = "oneOf";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransactionRequest" /> class
        /// with the <see cref="Deferred" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Deferred.</param>
        public CreateTransactionRequest(Deferred actualInstance)
        {
            IsNullable = false;
            SchemaType = "oneOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransactionRequest" /> class
        /// with the <see cref="Authenticate" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Authenticate.</param>
        public CreateTransactionRequest(Authenticate actualInstance)
        {
            IsNullable = false;
            SchemaType = "oneOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransactionRequest" /> class
        /// with the <see cref="Refund" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Refund.</param>
        public CreateTransactionRequest(Refund actualInstance)
        {
            IsNullable = false;
            SchemaType = "oneOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransactionRequest" /> class
        /// with the <see cref="Repeat" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Repeat.</param>
        public CreateTransactionRequest(Repeat actualInstance)
        {
            IsNullable = false;
            SchemaType = "oneOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTransactionRequest" /> class
        /// with the <see cref="Authorise" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Authorise.</param>
        public CreateTransactionRequest(Authorise actualInstance)
        {
            IsNullable = false;
            SchemaType = "oneOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(Authenticate))
                {
                    _actualInstance = value;
                }
                else if (value.GetType() == typeof(Authorise))
                {
                    _actualInstance = value;
                }
                else if (value.GetType() == typeof(Deferred))
                {
                    _actualInstance = value;
                }
                ...
                else if (value.GetType() == typeof(Refund))
                {
                    _actualInstance = value;
                }
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: Authenticate, Authorise, Deferred, Payment, Refund, Repeat");
                }
            }
        }
        ...
        {
            return (Payment)ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `Deferred`. If the actual instance is not `Deferred`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of Deferred</returns>
        public Deferred GetDeferred()
        {
            return (Deferred)ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `Authenticate`. If the actual instance is not `Authenticate`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of Authenticate</returns>
        public Authenticate GetAuthenticate()
        {
            return (Authenticate)ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `Refund`. If the actual instance is not `Refund`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of Refund</returns>
        public Refund GetRefund()
        {
            return (Refund)ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `Repeat`. If the actual instance is not `Repeat`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of Repeat</returns>
        public Repeat GetRepeat()
        {
            return (Repeat)ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `Authorise`. If the actual instance is not `Authorise`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of Authorise</returns>
        public Authorise GetAuthorise()
        {
            return (Authorise)ActualInstance;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of CreateTransactionRequest
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of CreateTransactionRequest</returns>
        public static CreateTransactionRequest FromJson(string jsonString)
        {
            CreateTransactionRequest newCreateTransactionRequest = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newCreateTransactionRequest;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(Authenticate).GetProperty("AdditionalProperties") == null)
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Authenticate>(jsonString, SerializerSettings));
                }
                else
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Authenticate>(jsonString, AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("Authenticate");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Authenticate: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(Authorise).GetProperty("AdditionalProperties") == null)
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Authorise>(jsonString, SerializerSettings));
                }
                else
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Authorise>(jsonString, AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("Authorise");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Authorise: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(Deferred).GetProperty("AdditionalProperties") == null)
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Deferred>(jsonString, SerializerSettings));
                }
                else
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Deferred>(jsonString, AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("Deferred");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Deferred: {1}", jsonString, exception.ToString()));
            }
            ...
            try
            {
                ...
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Payment>(jsonString, SerializerSettings));
                }
                else
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Payment>(jsonString, AdditionalPropertiesSerializerSettings));
                }
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(Refund).GetProperty("AdditionalProperties") == null)
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Refund>(jsonString, SerializerSettings));
                }
                else
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Refund>(jsonString, AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("Refund");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Refund: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(Repeat).GetProperty("AdditionalProperties") == null)
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Repeat>(jsonString, SerializerSettings));
                }
                else
                {
                    newCreateTransactionRequest = new CreateTransactionRequest(JsonConvert.DeserializeObject<Repeat>(jsonString, AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("Repeat");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Repeat: {1}", jsonString, exception.ToString()));
            }
        ...
        {
            return Equals(input as CreateTransactionRequest);
        }
    ...
    /// <summary>
    /// Custom JSON converter for CreateTransactionRequest
    /// </summary>
    public class CreateTransactionRequestJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)typeof(CreateTransactionRequest).GetMethod("ToJson").Invoke(value, null));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return CreateTransactionRequest.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
