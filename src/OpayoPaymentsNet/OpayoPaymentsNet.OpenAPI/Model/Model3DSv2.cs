...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// Model3DSv2
    /// </summary>
    [DataContract(Name = "3DSv2")]
    public partial class Model3DSv2 : IEquatable<Model3DSv2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Model3DSv2" /> class.
        /// </summary>
        /// <param name="statusCode">Code related to the &#x60;status&#x60; of the transaction. *You can lookup any status code on our [website](https://www.opayo.co.uk/support/troubleshooting/error-code).* .</param>
        ...
        /// <param name="acsUrl">A fully qualified URL that points to the 3D Secure authentication system at the card holder&#39;s issuing bank.</param>
        /// <param name="cReq">A Base64 encoded message to be passed to the Issuing Bank as part of the 3D Secure Authentication. This replaces the PAReq. When forwarding the &#x60;cReq&#x60; to the &#x60;acsUrl&#x60;, pass it in a field called &#x60;creq&#x60; (note the lower case &#x60;cr&#x60;).  This avoids issues at the ACS which expects the fieldname to be all lowercase. .</param>
        /// <param name="status">status.</param>
        public Model3DSv2(string statusCode = default, string statusDetail = default, string transactionId = default, string acsTransId = default, string dsTransId = default, string acsUrl = default, string cReq = default, string status = default)
        {
        ...
        /// <summary>
        /// Code related to the &#x60;status&#x60; of the transaction. *You can lookup any status code on our [website](https://www.opayo.co.uk/support/troubleshooting/error-code).* 
        /// </summary>
        /// <value>Code related to the &#x60;status&#x60; of the transaction. *You can lookup any status code on our [website](https://www.opayo.co.uk/support/troubleshooting/error-code).* </value>
        ...
        /// </summary>
        /// <value>A fully qualified URL that points to the 3D Secure authentication system at the card holder&#39;s issuing bank</value>
        ...
        {
            return Equals(input as Model3DSv2);
        }

        /// <summary>
        /// Returns true if Model3DSv2 instances are equal
        /// </summary>
        /// <param name="input">Instance of Model3DSv2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Model3DSv2 input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                ...
                (
                    AcsUrl == input.AcsUrl ||
                    AcsUrl != null &&
                    AcsUrl.Equals(input.AcsUrl)
                ) &&
                (
                    CReq == input.CReq ||
                    CReq != null &&
                    CReq.Equals(input.CReq)
                ) &&
                (
                    Status == input.Status ||
                    Status != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (AcsUrl != null)
                {
                    hashCode = hashCode * 59 + AcsUrl.GetHashCode();
                }
                if (CReq != null)
                {
                    hashCode = hashCode * 59 + CReq.GetHashCode();
                }
                if (Status != null)
                {
