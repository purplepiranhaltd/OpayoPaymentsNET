...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "retrieveTransaction_200_response_paymentMethod")]
    public partial class RetrieveTransaction200ResponsePaymentMethod : IEquatable<RetrieveTransaction200ResponsePaymentMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveTransaction200ResponsePaymentMethod" /> class.
        /// </summary>
        /// <param name="card">card.</param>
        public RetrieveTransaction200ResponsePaymentMethod(RetrieveTransaction200ResponsePaymentMethodCard card = default)
        {
            Card = card;
        }
        ...
        public RetrieveTransaction200ResponsePaymentMethodCard Card { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RetrieveTransaction200ResponsePaymentMethod {\n");
        ...
        {
            return Equals(input as RetrieveTransaction200ResponsePaymentMethod);
        }

        /// <summary>
        /// Returns true if RetrieveTransaction200ResponsePaymentMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of RetrieveTransaction200ResponsePaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveTransaction200ResponsePaymentMethod input)
        {
            if (input == null)
            {
                return false;
