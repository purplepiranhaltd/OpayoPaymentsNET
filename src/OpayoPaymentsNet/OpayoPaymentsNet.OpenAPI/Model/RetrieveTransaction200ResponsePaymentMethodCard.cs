...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "retrieveTransaction_200_response_paymentMethod_card")]
    public partial class RetrieveTransaction200ResponsePaymentMethodCard : IEquatable<RetrieveTransaction200ResponsePaymentMethodCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveTransaction200ResponsePaymentMethodCard" /> class.
        /// </summary>
        /// <param name="cardType">The type of the card used for the transaction..</param>
        /// <param name="lastFourDigits">The last 4 digits of the card number used for the transaction..</param>
        /// <param name="expiry">The expiry date of the card used for the transaction..</param>
        /// <param name="cardIdentifier">The unique reference of the card you want to charge..</param>
        /// <param name="reusable">A flag to indicate the card identifier is reusable, i.e. it has been created previously. (default to false).</param>
        public RetrieveTransaction200ResponsePaymentMethodCard(string cardType = default, string lastFourDigits = default, string expiry = default, Guid cardIdentifier = default, bool reusable = false)
        {
            CardType = cardType;
        ...
        /// </summary>
        /// <value>The type of the card used for the transaction.</value>
        ...
        /// </summary>
        /// <value>The last 4 digits of the card number used for the transaction.</value>
        ...
        /// </summary>
        /// <value>The expiry date of the card used for the transaction.</value>
        ...
        /// </summary>
        /// <value>The unique reference of the card you want to charge.</value>
        ...
        /// </summary>
        /// <value>A flag to indicate the card identifier is reusable, i.e. it has been created previously.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RetrieveTransaction200ResponsePaymentMethodCard {\n");
        ...
        {
            return Equals(input as RetrieveTransaction200ResponsePaymentMethodCard);
        }

        /// <summary>
        /// Returns true if RetrieveTransaction200ResponsePaymentMethodCard instances are equal
        /// </summary>
        /// <param name="input">Instance of RetrieveTransaction200ResponsePaymentMethodCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveTransaction200ResponsePaymentMethodCard input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                ...
                (
                    ...
                    LastFourDigits != null &&
                    LastFourDigits.Equals(input.LastFourDigits)
                ) &&
                (
                    Expiry == input.Expiry ||
                    Expiry != null &&
                    Expiry.Equals(input.Expiry)
                ) &&
                (
                    CardIdentifier == input.CardIdentifier ||
                    CardIdentifier != null &&
                    CardIdentifier.Equals(input.CardIdentifier)
                ) &&
                (
                    Reusable == input.Reusable ||
                    Reusable.Equals(input.Reusable)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = hashCode * 59 + LastFourDigits.GetHashCode();
                }
                if (Expiry != null)
                {
                ...
                {
                    hashCode = hashCode * 59 + CardIdentifier.GetHashCode();
                }
                hashCode = hashCode * 59 + Reusable.GetHashCode();
                return hashCode;
            }
        }
