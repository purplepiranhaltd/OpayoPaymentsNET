...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// CreateCiRequest
    /// </summary>
    [DataContract(Name = "createCi_request")]
    public partial class CreateCiRequest : IEquatable<CreateCiRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCiRequest" /> class.
        /// </summary>
        /// <param name="cardDetails">cardDetails.</param>
        public CreateCiRequest(CardDetails cardDetails = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCiRequest {\n");
        ...
        {
            return Equals(input as CreateCiRequest);
        }

        /// <summary>
        /// Returns true if CreateCiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCiRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                    ...
                    CardDetails != null &&
                    CardDetails.Equals(input.CardDetails)
                ;
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (CardDetails != null)
                {
                    hashCode = hashCode * 59 + CardDetails.GetHashCode();
                }
                return hashCode;
            }
        }
