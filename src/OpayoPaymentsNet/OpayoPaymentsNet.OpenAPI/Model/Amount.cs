...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    public partial class Amount : IEquatable<Amount>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="totalAmount">The total amount for the transaction that includes any sale or surcharge values..</param>
        /// <param name="saleAmount">The sale amount associated with the cost of goods or services for the transaction..</param>
        /// <param name="surchargeAmount">The surcharge amount added to the transaction as per the settings of the account..</param>
        public Amount(int totalAmount = default, int saleAmount = default, int surchargeAmount = default)
        {
        ...
        /// </summary>
        /// <value>The total amount for the transaction that includes any sale or surcharge values.</value>
        ...
        /// </summary>
        /// <value>The sale amount associated with the cost of goods or services for the transaction.</value>
        ...
        /// </summary>
        /// <value>The surcharge amount added to the transaction as per the settings of the account.</value>
        ...
        public bool Equals(Amount input)
        {
            ...
            return
                ...
                (
                    ...
                    SurchargeAmount.Equals(input.SurchargeAmount)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + SurchargeAmount.GetHashCode();
                return hashCode;
            }
        }
