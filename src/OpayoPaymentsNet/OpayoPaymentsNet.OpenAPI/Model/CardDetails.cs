...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    public partial class CardDetails : IEquatable<CardDetails>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CardDetails" /> class.
        /// </summary>
        /// <param name="cardholderName">The name of the card holder (required).</param>
        /// <param name="cardNumber">The number on the card (required).</param>
        /// <param name="expiryDate">The expiry date of the card in &#x60;MMYY&#x60; format (required).</param>
        /// <param name="securityCode">The card security code, also known as CV2, CVV, or CVC. This is used in CV2 checks. (required).</param>
        public CardDetails(string cardholderName = default, string cardNumber = default, string expiryDate = default, string securityCode = default)
        {
            // to ensure "cardholderName" is required (not null)
            if (cardholderName == null)
            {
                throw new ArgumentNullException("cardholderName is a required property for CardDetails and cannot be null");
            }
            CardholderName = cardholderName;
            // to ensure "cardNumber" is required (not null)
            if (cardNumber == null)
            {
                throw new ArgumentNullException("cardNumber is a required property for CardDetails and cannot be null");
            }
            CardNumber = cardNumber;
            // to ensure "expiryDate" is required (not null)
            if (expiryDate == null)
            {
                throw new ArgumentNullException("expiryDate is a required property for CardDetails and cannot be null");
            }
            ExpiryDate = expiryDate;
            // to ensure "securityCode" is required (not null)
            if (securityCode == null)
            {
                throw new ArgumentNullException("securityCode is a required property for CardDetails and cannot be null");
            }
        ...
        [DataMember(Name = "cardholderName", IsRequired = true, EmitDefaultValue = true)]
        public string CardholderName { get; set; }

        /// <summary>
        /// The number on the card
        /// </summary>
        /// <value>The number on the card</value>
        ...
        /// </summary>
        /// <value>The expiry date of the card in &#x60;MMYY&#x60; format</value>
        ...
        [DataMember(Name = "securityCode", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return Equals(input as CardDetails);
        }
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (CardholderName != null && CardholderName.Length > 45)
            {
                yield return new ValidationResult("Invalid value for CardholderName, length must be less than 45.", new[] { "CardholderName" });
            }

            // CardNumber (string) maxLength
            if (CardNumber != null && CardNumber.Length > 16)
            {
                yield return new ValidationResult("Invalid value for CardNumber, length must be less than 16.", new[] { "CardNumber" });
            }

            // ExpiryDate (string) maxLength
            if (ExpiryDate != null && ExpiryDate.Length > 4)
            {
                yield return new ValidationResult("Invalid value for ExpiryDate, length must be less than 4.", new[] { "ExpiryDate" });
            }

            // ExpiryDate (string) minLength
            if (ExpiryDate != null && ExpiryDate.Length < 4)
            {
                yield return new ValidationResult("Invalid value for ExpiryDate, length must be greater than 4.", new[] { "ExpiryDate" });
            }

            // SecurityCode (string) maxLength
            if (SecurityCode != null && SecurityCode.Length > 4)
            {
                yield return new ValidationResult("Invalid value for SecurityCode, length must be less than 4.", new[] { "SecurityCode" });
            }
