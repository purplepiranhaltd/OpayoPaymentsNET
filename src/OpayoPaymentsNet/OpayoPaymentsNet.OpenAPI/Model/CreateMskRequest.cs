...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// CreateMskRequest
    /// </summary>
    [DataContract(Name = "createMsk_request")]
    public partial class CreateMskRequest : IEquatable<CreateMskRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMskRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateMskRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMskRequest" /> class.
        /// </summary>
        /// <param name="vendorName">vendorName (required).</param>
        public CreateMskRequest(string vendorName = default)
        {
            // to ensure "vendorName" is required (not null)
            if (vendorName == null)
            {
                throw new ArgumentNullException("vendorName is a required property for CreateMskRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateMskRequest {\n");
        ...
        {
            return Equals(input as CreateMskRequest);
        }

        /// <summary>
        /// Returns true if CreateMskRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateMskRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateMskRequest input)
        {
            if (input == null)
            {
                return false;
