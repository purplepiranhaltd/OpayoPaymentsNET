...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Payment_paymentMethod")]
    public partial class PaymentPaymentMethod : IEquatable<PaymentPaymentMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public PaymentPaymentMethod(Card card = default, Applepay applepay = default)
        {
            Card = card;
            Applepay = applepay;
        }
        ...
        {
            return Equals(input as PaymentPaymentMethod);
        }

        /// <summary>
        /// Returns true if PaymentPaymentMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentPaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentPaymentMethod input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                ...
                (
                    ...
                    Applepay != null &&
                    Applepay.Equals(input.Applepay)
                );
        }
