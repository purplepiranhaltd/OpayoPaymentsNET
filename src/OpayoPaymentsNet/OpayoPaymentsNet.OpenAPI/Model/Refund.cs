...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    public partial class Refund : IEquatable<Refund>, IValidatableObject
    {
        ...
        /// <param name="amount">The amount refunded to the customer in the smallest currency unit. (e.g 100 pence to refund £1.00, or 1 to refund ¥1 (0-decimal currency)..</param>
        /// <param name="description">A brief description of the reason for the refund.</param>
        public Refund(TransactionTypeEnum? transactionType = default, string referenceTransactionId = default, string vendorTxCode = default, int amount = default, string description = default)
        {
        ...
        /// <summary>
        /// The amount refunded to the customer in the smallest currency unit. (e.g 100 pence to refund £1.00, or 1 to refund ¥1 (0-decimal currency).
        /// </summary>
        /// <value>The amount refunded to the customer in the smallest currency unit. (e.g 100 pence to refund £1.00, or 1 to refund ¥1 (0-decimal currency).</value>
        ...
        /// </summary>
        /// <value>A brief description of the reason for the refund</value>
