...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// Abort
    /// </summary>
    [DataContract(Name = "abort")]
    public partial class Abort : IEquatable<Abort>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Abort" /> class.
        /// </summary>
        /// <param name="instructionType">The type of the instruction.</param>
        public Abort(InstructionTypeEnum? instructionType = default)
        {
        ...
        {
            return Equals(input as Abort);
        }

        /// <summary>
        /// Returns true if Abort instances are equal
        /// </summary>
        /// <param name="input">Instance of Abort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Abort input)
        {
            if (input == null)
            {
                return false;
