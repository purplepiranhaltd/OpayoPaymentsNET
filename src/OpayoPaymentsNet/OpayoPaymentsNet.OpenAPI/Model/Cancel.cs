...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// Cancel
    /// </summary>
    [DataContract(Name = "cancel")]
    public partial class Cancel : IEquatable<Cancel>, IValidatableObject
    {
        /// <summary>
        ...
        public Cancel(InstructionTypeEnum? instructionType = default)
        {
        ...
        {
            return Equals(input as Cancel);
        }

        /// <summary>
        /// Returns true if Cancel instances are equal
        /// </summary>
        /// <param name="input">Instance of Cancel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Cancel input)
        {
            if (input == null)
            {
                return false;
