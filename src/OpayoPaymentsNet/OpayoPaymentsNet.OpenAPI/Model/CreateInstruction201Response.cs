...
{
    /// <summary>
    /// CreateInstruction201Response
    /// </summary>
    [DataContract(Name = "createInstruction_201_response")]
    public partial class CreateInstruction201Response : IEquatable<CreateInstruction201Response>, IValidatableObject
    {
        /// <summary>
        ...
        public InstructionTypeEnum? InstructionType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateInstruction201Response" /> class.
        /// </summary>
        /// <param name="instructionType">The type of the instruction..</param>
        /// <param name="date">Date/Time field is in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format..</param>
        public CreateInstruction201Response(InstructionTypeEnum? instructionType = default, string date = default)
        {
        ...
        /// <summary>
        /// Date/Time field is in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format.
        /// </summary>
        /// <value>Date/Time field is in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateInstruction201Response {\n");
        ...
        {
            return Equals(input as CreateInstruction201Response);
        }

        /// <summary>
        /// Returns true if CreateInstruction201Response instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateInstruction201Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateInstruction201Response input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                (
                    ...
                    InstructionType.Equals(input.InstructionType)
                ) &&
                (
                    Date == input.Date ||
                    Date != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + InstructionType.GetHashCode();
                if (Date != null)
                {
