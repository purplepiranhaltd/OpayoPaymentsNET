...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    public partial class ShippingDetails : IEquatable<ShippingDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ShippingDetails" /> class.
        /// </summary>
        /// <param name="recipientFirstName">Recipient&#39;s first names. (required).</param>
        /// <param name="recipientLastName">Recipient&#39;s last name. (required).</param>
        /// <param name="shippingAddress1">Shipping address line 1. (required).</param>
        /// <param name="shippingAddress2">Shipping address line 2..</param>
        /// <param name="shippingAddress3">Shipping address line 3..</param>
        /// <param name="shippingCity">Shipping city. (required).</param>
        /// <param name="shippingPostalCode">Shipping postal code. Not required when &#x60;shippingCountry&#x60; is &#x60;IE&#x60;..</param>
        /// <param name="shippingCountry">Shipping country. Two letter country code defined in [ISO 3166-1](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) (required).</param>
        ...
        public ShippingDetails(string recipientFirstName = default, string recipientLastName = default, string shippingAddress1 = default, string shippingAddress2 = default, string shippingAddress3 = default, string shippingCity = default, string shippingPostalCode = default, string shippingCountry = default, string shippingState = default)
        {
            // to ensure "recipientFirstName" is required (not null)
            if (recipientFirstName == null)
            {
                throw new ArgumentNullException("recipientFirstName is a required property for ShippingDetails and cannot be null");
            }
            RecipientFirstName = recipientFirstName;
            // to ensure "recipientLastName" is required (not null)
            if (recipientLastName == null)
            {
                throw new ArgumentNullException("recipientLastName is a required property for ShippingDetails and cannot be null");
            }
            RecipientLastName = recipientLastName;
            // to ensure "shippingAddress1" is required (not null)
            if (shippingAddress1 == null)
            {
                throw new ArgumentNullException("shippingAddress1 is a required property for ShippingDetails and cannot be null");
            }
            ShippingAddress1 = shippingAddress1;
            // to ensure "shippingCity" is required (not null)
            if (shippingCity == null)
            {
                throw new ArgumentNullException("shippingCity is a required property for ShippingDetails and cannot be null");
            }
            ShippingCity = shippingCity;
            // to ensure "shippingCountry" is required (not null)
            if (shippingCountry == null)
            {
                throw new ArgumentNullException("shippingCountry is a required property for ShippingDetails and cannot be null");
            }
        ...
        [DataMember(Name = "recipientFirstName", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "recipientLastName", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "shippingAddress1", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "shippingCity", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "shippingCountry", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return Equals(input as ShippingDetails);
        }

        /// <summary>
        /// Returns true if ShippingDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ShippingDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShippingDetails input)
        {
            if (input == null)
            {
                return false;
