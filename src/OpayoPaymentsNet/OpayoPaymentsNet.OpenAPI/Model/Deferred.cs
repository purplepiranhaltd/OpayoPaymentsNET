...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// Deferred
    /// </summary>
    [DataContract(Name = "Deferred")]
    public partial class Deferred : IEquatable<Deferred>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Deferred" /> class.
        /// </summary>
        ...
        {
            return Equals(input as Deferred);
        }

        /// <summary>
        /// Returns true if Deferred instances are equal
        /// </summary>
        /// <param name="input">Instance of Deferred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Deferred input)
        {
            if (input == null)
            {
                return false;
