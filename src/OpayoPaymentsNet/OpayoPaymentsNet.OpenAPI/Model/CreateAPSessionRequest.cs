...
{
    /// <summary>
    /// CreateAPSessionRequest
    /// </summary>
    [DataContract(Name = "createAPSession_request")]
    public partial class CreateAPSessionRequest : IEquatable<CreateAPSessionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAPSessionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAPSessionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAPSessionRequest" /> class.
        /// </summary>
        /// <param name="vendorName">vendorName (required).</param>
        /// <param name="domain">The domain that is registered with Opayo, that the transaction will originate from (required).</param>
        public CreateAPSessionRequest(string vendorName = default, string domain = default)
        {
            // to ensure "vendorName" is required (not null)
            if (vendorName == null)
            {
                throw new ArgumentNullException("vendorName is a required property for CreateAPSessionRequest and cannot be null");
            }
            VendorName = vendorName;
            // to ensure "domain" is required (not null)
            if (domain == null)
            {
                throw new ArgumentNullException("domain is a required property for CreateAPSessionRequest and cannot be null");
            }
            Domain = domain;
        }
        ...
        /// <summary>
        /// The domain that is registered with Opayo, that the transaction will originate from
        /// </summary>
        /// <value>The domain that is registered with Opayo, that the transaction will originate from</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAPSessionRequest {\n");
        ...
        {
            return Equals(input as CreateAPSessionRequest);
        }

        /// <summary>
        /// Returns true if CreateAPSessionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAPSessionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAPSessionRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                (
                    ...
                    VendorName != null &&
                    VendorName.Equals(input.VendorName)
                ) &&
                (
                    Domain == input.Domain ||
                    Domain != null &&
        ...
        {
            // VendorName (string) maxLength
            if (VendorName != null && VendorName.Length > 15)
            {
                yield return new ValidationResult("Invalid value for VendorName, length must be less than 15.", new[] { "VendorName" });
            }

            // Domain (string) maxLength
            if (Domain != null && Domain.Length > 255)
            {
                yield return new ValidationResult("Invalid value for Domain, length must be less than 255.", new[] { "Domain" });
            }
