...
{
    /// <summary>
    /// Create3DSecurev2Request
    /// </summary>
    [DataContract(Name = "create3DSecurev2_request")]
    public partial class Create3DSecurev2Request : IEquatable<Create3DSecurev2Request>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Create3DSecurev2Request" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Create3DSecurev2Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Create3DSecurev2Request" /> class.
        /// </summary>
        /// <param name="cRes">A Base64 encoded, encrypted message sent back by Issuing Bank to your Terminal URL at the end of the 3D-Authentication process. You will receive this value back from the Issuing Bank in a field called cres (lower case &#x60;cr&#x60;), but should be passed to Opayo as &#x60;cRes&#x60;.  (required).</param>
        public Create3DSecurev2Request(string cRes = default)
        {
            // to ensure "cRes" is required (not null)
            if (cRes == null)
            {
                throw new ArgumentNullException("cRes is a required property for Create3DSecurev2Request and cannot be null");
            }
            CRes = cRes;
        }

        /// <summary>
        /// A Base64 encoded, encrypted message sent back by Issuing Bank to your Terminal URL at the end of the 3D-Authentication process. You will receive this value back from the Issuing Bank in a field called cres (lower case &#x60;cr&#x60;), but should be passed to Opayo as &#x60;cRes&#x60;. 
        /// </summary>
        /// <value>A Base64 encoded, encrypted message sent back by Issuing Bank to your Terminal URL at the end of the 3D-Authentication process. You will receive this value back from the Issuing Bank in a field called cres (lower case &#x60;cr&#x60;), but should be passed to Opayo as &#x60;cRes&#x60;. </value>
        [DataMember(Name = "cRes", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Create3DSecurev2Request {\n");
        ...
        {
            return Equals(input as Create3DSecurev2Request);
        }

        /// <summary>
        /// Returns true if Create3DSecurev2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of Create3DSecurev2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Create3DSecurev2Request input)
        {
            if (input == null)
            {
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (CRes != null)
                {
                    hashCode = hashCode * 59 + CRes.GetHashCode();
                }
                return hashCode;
            }
        }
