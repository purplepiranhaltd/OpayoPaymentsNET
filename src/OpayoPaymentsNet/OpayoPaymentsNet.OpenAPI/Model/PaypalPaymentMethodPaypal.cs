...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Paypal_paymentMethod_paypal")]
    public partial class PaypalPaymentMethodPaypal : IEquatable<PaypalPaymentMethodPaypal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaypalPaymentMethodPaypal" /> class.
        /// </summary>
        /// <param name="orderId">The PayPal order id..</param>
        /// <param name="payerId">The PayPal payer id..</param>
        public PaypalPaymentMethodPaypal(string orderId = default, string payerId = default)
        {
            OrderId = orderId;
            PayerId = payerId;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaypalPaymentMethodPaypal {\n");
        ...
        {
            return Equals(input as PaypalPaymentMethodPaypal);
        }

        /// <summary>
        /// Returns true if PaypalPaymentMethodPaypal instances are equal
        /// </summary>
        /// <param name="input">Instance of PaypalPaymentMethodPaypal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaypalPaymentMethodPaypal input)
        {
            if (input == null)
            {
                return false;
