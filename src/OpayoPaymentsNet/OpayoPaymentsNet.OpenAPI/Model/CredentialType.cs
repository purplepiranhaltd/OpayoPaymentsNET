...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "credentialType")]
    public partial class CredentialType : IEquatable<CredentialType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether you are storing the credential to file for the first time. When storing the credential for the first time you must also submit the &#x60;strongCustomerAuthentication&#x60; object and &#x60;apply3DSecure&#x60;:&#x60;Force&#x60;, as the cardholder must undergo a 3D Secure authentication with a challenge before you can safely store the credential to file. 3D Secure authentication is not currently required for Mail Order Telephone Order (MOTO) transactions.   * &#x60;First&#x60; &#x3D; You are first storing a credential on file.   * &#x60;Subsequent&#x60; &#x3D; You are using a stored credential </value>
        ...
        /// Initializes a new instance of the <see cref="CredentialType" /> class.
        /// </summary>
        /// <param name="cofUsage">Indicates whether you are storing the credential to file for the first time. When storing the credential for the first time you must also submit the &#x60;strongCustomerAuthentication&#x60; object and &#x60;apply3DSecure&#x60;:&#x60;Force&#x60;, as the cardholder must undergo a 3D Secure authentication with a challenge before you can safely store the credential to file. 3D Secure authentication is not currently required for Mail Order Telephone Order (MOTO) transactions.   * &#x60;First&#x60; &#x3D; You are first storing a credential on file.   * &#x60;Subsequent&#x60; &#x3D; You are using a stored credential  (required).</param>
        ...
        public CredentialType(CofUsageEnum cofUsage = default, InitiatedTypeEnum initiatedType = default, MitTypeEnum? mitType = default, string recurringExpiry = default, string recurringFrequency = default, string purchaseInstalData = default)
        {
            CofUsage = cofUsage;
        ...
        {
            return Equals(input as CredentialType);
        }

        /// <summary>
        /// Returns true if CredentialType instances are equal
        /// </summary>
        /// <param name="input">Instance of CredentialType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CredentialType input)
        {
            if (input == null)
            {
                return false;
