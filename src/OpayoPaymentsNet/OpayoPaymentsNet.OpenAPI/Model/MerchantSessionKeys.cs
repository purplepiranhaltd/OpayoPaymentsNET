...
namespace OpayoPaymentsNet.OpenAPI.Model
{
    ...
    /// MerchantSessionKeys
    /// </summary>
    [DataContract(Name = "MerchantSessionKeys")]
    public partial class MerchantSessionKeys : IEquatable<MerchantSessionKeys>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantSessionKeys" /> class.
        /// </summary>
        /// <param name="merchantSessionKey">merchantSessionKey.</param>
        /// <param name="expiry">Date/Time in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format.</param>
        public MerchantSessionKeys(string merchantSessionKey = default, string expiry = default)
        {
        ...
        /// <summary>
        /// Gets or Sets MerchantSessionKey
        /// </summary>
        [DataMember(Name = "merchantSessionKey", EmitDefaultValue = false)]
        public string MerchantSessionKey { get; set; }

        /// <summary>
        /// Date/Time in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format
        /// </summary>
        /// <value>Date/Time in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MerchantSessionKeys {\n");
            sb.Append("  MerchantSessionKey: ").Append(MerchantSessionKey).Append("\n");
        ...
        {
            return Equals(input as MerchantSessionKeys);
        }

        /// <summary>
        /// Returns true if MerchantSessionKeys instances are equal
        /// </summary>
        /// <param name="input">Instance of MerchantSessionKeys to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantSessionKeys input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                (
                    MerchantSessionKey == input.MerchantSessionKey ||
                    MerchantSessionKey != null &&
                    MerchantSessionKey.Equals(input.MerchantSessionKey)
                ) &&
                (
                    Expiry == input.Expiry ||
                    Expiry != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = hashCode * 59 + MerchantSessionKey.GetHashCode();
                }
                if (Expiry != null)
                {
